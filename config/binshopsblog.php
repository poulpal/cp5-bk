...
return [
    ...
    'include_default_routes' => false, // set to false to not include routes.php for BinshopsBlogReaderController and admin related routes. Default: true. If you disable this, you will have to manually copy over the data from routes.php and add it to your web.php.
    ...
    'per_page' => 12, // how many posts to show per page on the blog index page. Default: 10
    ...
    'memory_limit' => '4096M', // This is used when uploading images :
    ...
    'rssfeed' => [
        ...
        'description' => "RSS فید پولپل", //description for the RSS feed
        'language' => "fa", // see https://www.w3.org/TR/REC-html40/struct/dirlang.html#langcodes
    ],
