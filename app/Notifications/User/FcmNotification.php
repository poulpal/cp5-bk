...
class FcmNotification extends Notification implements ShouldQueue
{
    ...
    public function toFcm($notifiable)
    {
        ...
        $text = str_replace(
            ['{unit_number}', '{user_first_name}', '{user_last_name}', '{charge_amount_in_rial}', '{fcmmessage_amount_in_rial}', '{unit_payment_link}'],
            [
        ...
        return [
            'title' => 'پیام از طرف مدیریت ساختمان',
            'body' => $text,
            'data' => [
                'url' => $link ?? 'https://chargepal.ir'
            ]
        ];
    }
}
